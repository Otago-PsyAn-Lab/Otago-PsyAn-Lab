...
public interface LoopCallbacks {
    ...
    void addLoopDataChangeListener(ExperimentDesignerActivity.LoopDataChangeListener listener);
    ...
    void removeLoopDataChangeListener(ExperimentDesignerActivity.LoopDataChangeListener listener);
}
