...
import nz.ac.otago.psyanlab.common.util.MoreMath;
import nz.ac.otago.psyanlab.common.util.ThemeUtils;
...
public class AlphaTouchInterceptorOverlay extends FrameLayout {
    ...
    public AlphaTouchInterceptorOverlay(Context context) {
        ...
        final int resId = ThemeUtils.getSelectableItemBackground(context
                .getTheme());
    ...
    private void setAlphaOnViewBackground(View view, float alpha) {
