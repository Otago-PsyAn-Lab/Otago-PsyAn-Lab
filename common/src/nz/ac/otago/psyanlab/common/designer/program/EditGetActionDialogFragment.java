...
public class EditGetActionDialogFragment extends DialogFragment {
     ...
     */
    public static EditGetActionDialogFragment newDialog(long id) {
        EditGetActionDialogFragment f = new EditGetActionDialogFragment();
