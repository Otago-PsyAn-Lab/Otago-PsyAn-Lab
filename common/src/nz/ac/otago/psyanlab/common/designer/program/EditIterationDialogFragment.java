...
public class EditIterationDialogFragment extends DialogFragment {
     ...
     */
    public static EditIterationDialogFragment newDialog(long id) {
        EditIterationDialogFragment f = new EditIterationDialogFragment();
