...
public class DragSortController extends SimpleFloatViewManager implements View.OnTouchListener,
    ...
    private boolean mLongTouchDragAnywhere;
    ...
    public void onLongPress(MotionEvent e) {
        ...
        if (mLongTouchDragAnywhere) {
            mHitPos = viewIdHitPosition(e, 0);
        }
        if (mHitPos != MISS && (mDragInitMode == ON_LONG_PRESS || mLongTouchDragAnywhere)) {
            mDslv.performHapticFeedback(HapticFeedbackConstants.LONG_PRESS);
            startDrag(mHitPos, mCurrX - mItemX, mCurrY - mItemY);
        }
    }

    public void setLongTouchDragAnywhere(boolean longTouchDragAnywhere) {
        mLongTouchDragAnywhere = longTouchDragAnywhere;
    }
