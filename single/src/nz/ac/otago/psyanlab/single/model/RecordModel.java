...
public class RecordModel extends DbModel {
    public static final String CREATE_TABLE = "create table record (_id integer primary key autoincrement, exp_id number not null, file text not null, file_size number not null, date number not null, note text, session_id number not null); ";
    ...
    public static void deleteExperimentRecords(SQLiteDatabase db, long id) {
        db.delete(TABLE, KEY_EXP_ID + "=" + id, null);
    }
    ...
    public RecordModel(Bundle b) {
        ...
        if (b.containsKey(KEY_EXP_ID)) {
            userExperimentId = b.getLong(KEY_EXP_ID);
        }
    ...
    public RecordModel(Cursor c) {
        ...
        if (c.getColumnIndex(KEY_EXP_ID) != INVALID_ID) {
            userExperimentId = c.getLong(c.getColumnIndex(KEY_EXP_ID));
        }
    ...
    public Bundle bundle() {
        Bundle b = new Bundle();
        b.putLong(KEY_ID, id);
        b.putLong(KEY_EXP_ID, userExperimentId);
